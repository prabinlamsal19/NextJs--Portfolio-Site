      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">Kathmandu University</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">
              I am a proficient developer in MERN stack and Machine Learning.
            </p>
    ...
    <section>
      ...
      <div className='lg:flex gap-10'>
        ...
        <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
          ...
          <p className='text-gray-800 py-1'>BooksForMe</p>
          <p className='text-gray-800 py-1'>Cryptify</p>
          <p className='text-gray-800 py-1'>HaatBazar</p>
          <p className='text-gray-800 py-1'>Travel Nepal</p>
          <p className='text-gray-800 py-1'>Facebook + Messenger Clone</p>
